      ...
      <View style={styles.container}>
        <ScrollView contentContainerStyle={styles.scrollContainer}>
          <View style={styles.profileSection}>
            <Image
              source={{ uri: 'https://via.placeholder.com/120' }} // Replace with your profile image URL
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.text}>
              I am a passionate software developer with a knack for creating intuitive and visually stunning mobile applications. When I'm not coding, you'll find me exploring photography, hiking, or curating playlists.
            </Text>
          </View>
